...
public abstract class EditorEntryPoint implements EntryPoint
{
  ...
  protected CustomisationPool customisationPool;
  
  private class CustomisationPoolAsyncCallback implements AsyncCallback<CustomisationPool>
  {
	@Override
	public void onFailure(Throwable caught) {
		System.out.println("FAIL : " + caught.toString());
	}
  ...
  {
	  UICustomParserServiceAsync uiCustomParserServiceAsync = UICustomParserService.Util.getInstance();
	  uiCustomParserServiceAsync.parseUICustomFile("/C.uiCustom", new CustomisationPoolAsyncCallback());
  }
